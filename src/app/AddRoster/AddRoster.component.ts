...
import { RecipientProfile } from 'app/org.degree';
	...
	async submit(): Promise<any> {
		...
		if (this.myForm.valid) {
			...
			this.Transaction = {
				...
				'templateId': 'resource:org.degree.CertificateTemplate#'+this.templateId.value,
				'localAdministrator': 'resource:org.degree.Administrator#'+this.authService.currentUser.email,
